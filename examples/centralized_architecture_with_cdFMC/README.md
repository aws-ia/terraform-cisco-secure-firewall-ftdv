<!-- BEGIN_TF_DOCS -->
# AWS GWLB Centralized Architecture setup with Cisco Secure Firewall and Cloud-delivered FMC
...
### Service VPC
- service vpc is created for usecase new service new spoke
...
### Spoke VPC
- If usecase is **centralized with new spoke**, 1 Spoke VPC with 2 subnets in different AZ
