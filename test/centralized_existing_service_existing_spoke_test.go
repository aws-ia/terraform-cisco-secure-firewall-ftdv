...
func TestExistingServiceExistingSpoke(t *testing.T) {
	...
	terraDir2 := "../examples/Centralized_Architecture_with_fmc_existing_spoke"
	...
	test_structure.RunTestStage(t, "setup", func() {
		...
		if err != nil {
			...
			fmt.Println("centralized_architecture_with_fmc_existing_spoke completed successfully. Output:", output)
		}
	})
