...
| <a name="input_gwlb_name"></a> [gwlb\_name](#input\_gwlb\_name) | name for Gateway loadbalancer | `string` | `"dao-GWLB"` | no |
...
| <a name="input_inbound"></a> [inbound](#input\_inbound) | direction of traffic flow for distributed architecture | `bool` | `false` | no |
...
| <a name="input_ngw_subnet_cidr"></a> [ngw\_subnet\_cidr](#input\_ngw\_subnet\_cidr) | List out NGW Subnet CIDR . | `list(string)` | <pre>[<br>  "10.6.211.0/24",<br>  "10.6.221.0/24"<br>]</pre> | no |
